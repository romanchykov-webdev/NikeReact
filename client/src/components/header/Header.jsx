...
const Header = () => {
    ...
    const itemsHeaderSlider=[
        {id:2, article: 2,name:'Nike Cosmic Unity 2',price:210,img:img1, colors:['black','red'], sizes:[41,42,43,44,45]},
        {id:3, article: 3,name:'NIKE SB DUNK HIGH',price:220,img:img2,colors:['black','red','orange'], sizes:[41,42,43,44]},
        {id:4,article: 4, name:'NIKE DYNAMO GO SE',price:230,img:img3, colors:['black','red', 'orange'], sizes:[41,42,43,44]},
        {id:5,article: 5,name:'NIKE SB DUNK HIGH',price:220,img:img2,colors:['black','red','orange'], sizes:[41,42,43,44]},
    ]
